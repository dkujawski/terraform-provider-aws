...
func resourceAwsS3BucketReplicationRule() *schema.Resource {
	return &schema.Resource{
		Create: resourceAwsS3BucketReplicationRuleAdd,
		Read:   resourceAwsS3BucketReplicationRuleRead,
		Update: resourceAwsS3BucketReplicationRuleUpdate,
		Delete: resourceAwsS3BucketReplicationRuleRemove,
...
func resourceAwsS3BucketReplicationRuleAdd(d *schema.ResourceData, meta interface{}) error {
	// Get the bucket
	var bucket string
...
func resourceAwsS3BucketReplicationRuleRead(d *schema.ResourceData, meta interface{}) error {
...
func resourceAwsS3BucketReplicationRuleUpdate(d *schema.ResourceData, meta interface{}) error {
	s3conn := meta.(*AWSClient).s3conn
...
func resourceAwsS3BucketReplicationRuleRemove(d *schema.ResourceData, meta interface{}) error {
